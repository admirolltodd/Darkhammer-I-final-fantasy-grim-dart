...
DUNGEON_CONFIGS = {
    "dungeon1": {
        "name": "ORK ENCAMPMENT ALPHA",
        "floors": 3,
        "width": 32, "height": 32,
        "zone": ZONE_ENCAMPMENT,
        "enemy_scale": 1.0,
        "key_item": None,
        "boss": "ork_warboss_gorkamorka",
        "intro_text": "THE ENCAMPMENT REEKS OF FUNGUS BREW AND EXHAUST. ORKS EVERYWHERE. WARBOSS GORKAMORKA HOLDS THIS SECTOR.",
    },
    "dungeon2": {
        "name": "FUNGAL CAVES",
        "floors": 5,
        "width": 40, "height": 40,
        "zone": ZONE_FUNGAL_CAVES,
        "enemy_scale": 1.5,
        "key_item": None,
        "boss": "squiggoth_great",
        "dark_floors": [3, 4, 5],
        "intro_text": "THE CAVES PULSE WITH ALIEN GROWTH. A GREAT SQUIGGOTH STIRS IN THE DEPTHS. THE WALLS SMELL OF SOMETHING VERY ALIVE.",
    },
    "dungeon3": {
        "name": "CAPTURED MANUFACTORUM",
        "floors": 6,
        "width": 40, "height": 40,
        "zone": ZONE_MANUFACTORUM,
        "enemy_scale": 2.0,
        "key_item": None,
        "boss": "mad_dok",
        "intro_text": "ONCE SACRED TO THE OMNISSIAH. NOW ORK MACHINES GRIND WHERE HUMAN ONES STOOD. MAD DOK GROTSNIK RUNS HIS EXPERIMENTS HERE.",
    },
    "dungeon_void": {
        "name": "ORK ROK CRASHSITE",
        "floors": 4,
        "width": 30, "height": 30,
        "zone": ZONE_ROK,
        "enemy_scale": 2.5,
        "key_item": None,
        "boss": "warboss_skullkrumpa",
        "intro_text": "AN ORK ROK — A HOLLOWED ASTEROID CONVERTED TO A DROP-SHIP — CRASHED IN THE ASH WASTES. SOMETHING SURVIVED INSIDE.",
    },
    "dungeon_final": {
        "name": "GHAZGHKULL'S IRON FORTRESS",
        "floors": 7,
        "width": 48, "height": 48,
        "zone": ZONE_IRON_FORTRESS,
        "enemy_scale": 3.0,
        "key_item": None,
        "boss": "ghazghkull_p1",
        "intro_text": "THIS IS IT. THE IRON FORTRESS THRUMS WITH WAAAGH! ENERGY. GHAZGHKULL MAG URUK THRAKA AWAITS. THE GREATEST ORK TO EVER LIVE.",
    },
}
